...
import 'package:irrigacao/Widgets/LoadingContainer.dart';
                    ...
                    Column(
                      children: [
                        ...
                        RotatedBox(
                          quarterTurns: -1,
                          child: Slider(
                            value: widget.parameters.humidityOnPercentage
                                .toDouble(),
                            min: 0,
                            max: 100,
                            divisions: 100,
                        ...
                        Text(
                            '${widget.parameters.humidityOnPercentage.toInt()}%'),
                      ],
                    ),
                    Stack(
                    ...
                    Column(
                      children: [
                        ...
                        RotatedBox(
                          quarterTurns: -1,
                          child: Slider(
                            value: widget.parameters.humidityOffPercentage
                                .toDouble(),
                            min: 0,
                            max: 100,
                            divisions: 100,
